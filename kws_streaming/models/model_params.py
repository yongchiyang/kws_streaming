...
def tinyml_dscnn_params():
  """Parameters for toy "depthwise convolutional neural network" stride model."""
  params = Params()
  params.model_name = 'tinyml_dscnn'
  params.maxpool_size = '(1,2)'
  params.maxpool_stride = '(1,2)'
  params.cnn1_kernel_size = '(1,6)'
  params.cnn1_strides = '(1,2)'
  params.cnn1_padding = 'valid'
  params.cnn1_filters = 3
  params.bn_momentum = 0.1
  params.bn_epsilon = 1e-5
  params.act = "'relu','relu'"
  params.dw2_kernel_size = '(1,5),(1,4)'
  params.dw2_depth_multiplier = '1,2'
  params.dw2_strides = '(2,2),(1,1)'
  params.dw2_padding = 'valid'
  params.avgpool_size = '(1,2)'
  params.avgpool_stride = '(1,2)'
  params.dw2_kernel_size = '(1,4),(1,4)'
  params.dw2_depth_multiplier = '2,2'
  params.dw2_strides = '(2,2),(2,2)'
  params.dw2_padding = 'valid'
  params.dropout = 0.5
  params.units1 = 10
  params.units2 = 2
...
HOTWORD_MODEL_PARAMS = {
    ...
    'tinyml_dscnn': tinyml_dscnn_params(),
    'tinyml_dscnn_cc': tinyml_dscnn_cc_params(),
    'gru': gru_params(),
    'lstm': lstm_params(),
