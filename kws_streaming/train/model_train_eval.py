...
import kws_streaming.models.tinyml_dscnn as tinyml_dscnn
import kws_streaming.models.tinyml_dscnn_cc as tinyml_dscnn_cc
  ...
  for opt_name, optimizations in name2opt.items():
    ...
    if model_is_streamable:
      ...
      if not opt_name:
        ...
        try:
          folder_name = 'tf'
          print("in model_train_eval tf external")
          ...
          print("for internal model in model_train_eval")
          test.tf_stream_state_internal_model_accuracy(
              flags,
              folder_name,
              accuracy_name='tf_stream_state_internal_model_accuracy_sub_set',
...
if __name__ == '__main__':
  ...
  # tinyml_dscnn model settings
  parser_tinyml_dscnn = subparsers.add_parser('tinyml_dscnn')
  tinyml_dscnn.model_parameters(parser_tinyml_dscnn)

  # tinyml_dscnn_cc model settings
  parser_tinyml_dscnn_cc = subparsers.add_parser('tinyml_dscnn_cc')
  tinyml_dscnn_cc.model_parameters(parser_tinyml_dscnn_cc)
