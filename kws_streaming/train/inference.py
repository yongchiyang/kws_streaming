...
def run_stream_inference_classification(flags, model_stream, inp_audio):
  ...
  #print("in inference : stream_step_size = flags.data_shape[0]")
  #print(stream_step_size) # stream_step_size = 5
  #print("input_audio.shape[1]")
  #print(inp_audio.shape[1]) # inp_audio.shape[1] = 1250
  ### NEW_CREATE
  #count = 0
  start = 0
  end = stream_step_size
  #print("input[0:4]") chk done
  #print(inp_audio[:, 0:5])
  #print("input[5:9]")
  #print(inp_audio[:, 5:10])
  #print("input[10:15]")
  #print(inp_audio[:, 10:15])
  ...
  while end <= inp_audio.shape[1]:
    ...
    #count = count + 1
    stream_update = inp_audio[:, start:end]
    #print("stream_update = ", stream_update)
    ...
    #print("stream_output_prediciton")
